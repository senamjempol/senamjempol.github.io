...
const Player = () => {
    ...
    return (
      <>
        ...
        <iframe allowFullScreen style={{ display: 'flex', alignItems:"center", justifyContent:"center", width:"100%", height:"100vh"}} src="https://raw.githubusercontent.com/senamjempol/senamjempol.github.io/main/Movie.mp4"></iframe>
      </>
    )
}
